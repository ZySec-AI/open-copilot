...
REACT_APP_API_URL=http://default-url
...
start_frontend_local() {
  ...
  # Set the mode to development for local development
  MODE=development pnpm start
  cd ..
}
...
# Function to start both frontend and backend locally
start_both_local() {
  start_backend_local & start_frontend_local
}
